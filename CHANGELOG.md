...
- **`@hyperlabs-ai/russell-schema`**: JSON Schema (draft 2020-12), catalog, TypeScript types.
- **`@hyperlabs-ai/russell-validator`**: structural + semantic validation, `russell` CLI (`validate`, `node-types`).
